    ...
    <div class="panel panel-success">
     <div class = "color">
        ...
        <div class="panel-body" style="margin-top: 5px ;">
            <c:if test="${empty mindList}">
                No Campus minds Data present!
            </c:if>
            <c:if test="${not empty mindList}">   
                ...
                <table class="table table-hover table-bordered">	
                    ...
                    <tbody>
                    <c:forEach items="${mindList}" var="minds">
                        <tr>
                            <th><c:out value="${minds.mId}"/></th>
                            <th><c:out value="${minds.name}"/></th>
                            <th><c:out value="${minds.lead.name}"/></th>
                            <th><c:out value="${minds.lead.orchardTrack.trackName}"/></th> 
