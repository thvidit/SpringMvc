        ...
        <div class="panel-body" style="margin-top: 5px ;">
            ...
            <c:if test="${not empty leadList}">   
                ...
                <table class="table table-hover table-bordered">	
                    ...
                    <tbody>
                    <c:forEach items="${leadList}" var="leads">
                        <tr>
                            <th><c:out value="${leads.mId}"/></th>
                            <th><c:out value="${leads.name}"/></th>
                            <th><c:out value="${leads.leadsId}"/></th>
                            <th><c:out value="${leads.orchardTrack.trackName}"/></th> 
